...
const DN_I18N_DICTIONARY = {
  en: {
    ...
    "stays.prop_hotels": "Hotels & Resorts",
    "stays.prop_airbnb": "Airbnb Apartments",
    "stays.prop_free": "Free Hotels Stay",
    "stays.prop_timeshare": "Timeshare Resorts",
    "stays.star_5": "5-star",
    "stays.star_4": "4-star",
    "stays.star_3": "3-star",
    "stays.price_tax_hint": "Per night, before taxes",
    "stays.amenity_pool": "Infinity Pool",
    "stays.amenity_breakfast": "Free Breakfast",
    "stays.amenity_spa": "Spa",
    "stays.amenity_wifi": "Free Wi-Fi",
    "stays.amenity_beachfront": "Beach Front",
    "stays.area_label": "Area",
    "stays.area_mykhe": "My Khe",
    "stays.area_city": "City Center",
    "stays.area_sontra": "Son Tra",
    "stays.area_anthuong": "An Thuong",
    "stays.card1_sub": "Happy Hotel - Beachfront",
    "stays.card1_desc": "Panoramic sea views, rooftop infinity pool, and world-class spa treatments. Just 2 mins walk to the sand.",
    "stays.superhost": "Superhost",
    "stays.card2_sub": "Modern Loft Apartment - Near Dragon Bridge",
    "stays.card2_desc": "Authentic local living in the city center. Fully equipped kitchen, fast Wi-Fi, and a cozy workspace. Perfect for digital nomads.",
    "stays.kitchen": "Kitchen",
    "stays.high_speed_net": "High Speed Net",
    "stays.washer": "Washer",
    "stays.quiet_peaceful": "Quiet & Peaceful",
    "stays.card3_sub": "Malean Retreat - Resort Villa",
    "stays.card3_desc": "Escape to a sanctuary of peace and tropical beauty. Private pools, organic breakfast, and daily yoga sessions included.",
    "stays.restaurant": "Restaurant",
    "stays.free_bikes": "Free Bikes",
    "guides.read_more": "Read more →",
    "guides.food_tag": "Street Food",
    "guides.moto_tag": "Motorbike Guide",
    "guides.saver_tag": "Money Saver",
    ...
    "why_us.f1_tag": "Instant confirmation",
    ...
    "why_us.f2_tag": "Hotline / WhatsApp / Zalo 24/7",
    ...
    "why_us.f3_tag": "100% Certified Guides",
    ...
    "why_us.f4_tag": "Insurance & AC vehicles",
    ...
    "why_us.f5_tag": "24h Free cancellation",
    ...
    "why_us.f6_tag": "Save 20% - 40% vs standard",
    ...
    "why_us.f7_tag": "Real Central Vietnam soul",
    ...
    "why_us.f8_tag": "Free custom trip planning",
    ...
    "why_us.f9_tag": "Eco-friendly practices",
    ...
    "reviews.verified_count": "12,800+ verified ratings",
    "reviews.google_sub": "6,500+ Local Reviews",
    "reviews.tripadvisor_sub": "Traveller's Choice 2025",
    "reviews.getyourguide_sub": "Top Rated Tour Partner",
    ...
    "reviews.r1_text": "\"Jun was such an incredible tour guide! He was very knowledgeable about Ba Na Hills and showed us the best photo spots before the crowds arrived. Pick up and drop off from my hotel was super punctual and smooth. Highly recommend!\"",
    "reviews.r1_tag": "United Kingdom • Ba Na Hills Tour",
    "reviews.r2_text": "\"The pick-up and return were all great. Pleasant day, our tour guide looked after us so well with lots of insights into local culture. The lantern boat ride in Hoi An was absolutely magical for our family. No hidden charges at all!\"",
    "reviews.r2_tag": "Singapore • Hoi An Sunset Tour",
    "reviews.r3_text": "\"Amazing experience! The coastal train views over Hai Van Pass are astonishing. Our tour guide Oanh provided fascinating historic details and took great care of everyone. Best value tour we've done in Vietnam!\"",
    "reviews.r3_tag": "Australia • Hue Heritage Train Tour",
    "reviews.r4_text": "\"The price was very reasonable and I was extremely satisfied! The guides drove very safely and introduced delicious authentic food that typical tourists wouldn't find. 10/10 experience!\"",
    "reviews.r4_tag": "Japan • Da Nang Food Tour",
    "reviews.r5_text": "\"Our family was extremely satisfied with the Cham Islands tour. Brand new speedboat, crystal-clear water with awesome coral snorkeling, and fresh seafood lunch with zero surcharges. Will definitely book again!\"",
    "reviews.r5_tag": "Hanoi, VN • Cham Islands Tour",
    "reviews.r6_text": "\"Great trip, great guide, great food, great locations! Highest recommendation to our guide. Excellent communication in English and seamless booking through the website. Truly Da Nang for Less!\"",
    "reviews.r6_tag": "Germany • Da Nang City Tour",

    // Book Without Stress Banner
    "stressfree.badge": "12+ Years of Local Excellence",
    ...
    "stressfree.b1": "Free Cancellation (24h)",
    "stressfree.b2": "Zero Hidden Costs",
    "stressfree.b3": "Free Hotel Pick-up",
    ...
    "guides.more_title": "More Travel Guides & Local Recommendations",
    "guides.read_time_4": "4 min read",
    "guides.read_time_6": "6 min read",
    "guides.read_time_3": "3 min read",
  ...
  vn: {
    ...
    "stays.prop_hotels": "Khách sạn & Resort",
    "stays.prop_airbnb": "Căn hộ Airbnb",
    "stays.prop_free": "Nghỉ khách sạn miễn phí",
    "stays.prop_timeshare": "Resort Timeshare",
    "stays.star_5": "5 sao",
    "stays.star_4": "4 sao",
    "stays.star_3": "3 sao",
    "stays.price_tax_hint": "Mỗi đêm, chưa bao gồm thuế",
    "stays.amenity_pool": "Hồ bơi vô cực",
    "stays.amenity_breakfast": "Bữa sáng miễn phí",
    "stays.amenity_spa": "Spa & Thư giãn",
    "stays.amenity_wifi": "WiFi miễn phí",
    "stays.amenity_beachfront": "Sát bờ biển",
    "stays.area_label": "Khu vực",
    "stays.area_mykhe": "Mỹ Khê",
    "stays.area_city": "Trung tâm",
    "stays.area_sontra": "Sơn Trà",
    "stays.area_anthuong": "An Thượng",
    "stays.card1_sub": "Khách sạn nghỉ dưỡng - Sát biển Mỹ Khê",
    "stays.card1_desc": "Tầm nhìn toàn cảnh biển, hồ bơi vô cực trên tầng thượng và dịch vụ spa đẳng cấp thế giới. Chỉ 2 phút đi bộ ra bãi cát.",
    "stays.superhost": "Chủ nhà siêu cấp",
    "stays.card2_sub": "Căn hộ Loft hiện đại - Gần Cầu Rồng",
    "stays.card2_desc": "Không gian sống bản địa giữa lòng trung tâm thành phố. Đầy đủ tiện nghi bếp, Wi-Fi tốc độ cao và bàn làm việc yên tĩnh. Lý tưởng cho người làm việc từ xa.",
    "stays.kitchen": "Bếp nấu",
    "stays.high_speed_net": "Mạng tốc độ cao",
    "stays.washer": "Máy giặt",
    "stays.quiet_peaceful": "Yên tĩnh & Thanh bình",
    "stays.card3_sub": "Khu nghỉ dưỡng cao cấp - Biệt thự Resort",
    "stays.card3_desc": "Hòa mình vào không gian thanh bình và vẻ đẹp nhiệt đới. Hồ bơi riêng biệt, bữa sáng organic và lớp yoga hàng ngày miễn phí.",
    "stays.restaurant": "Nhà hàng",
    "stays.free_bikes": "Xe đạp miễn phí",
    "guides.read_more": "Đọc tiếp →",
    "guides.food_tag": "Ẩm thực đường phố",
    "guides.moto_tag": "Phượt xe máy",
    "guides.saver_tag": "Mẹo tiết kiệm",
    ...
    "why_us.f1_tag": "Xác nhận tức thì trong 60s",
    ...
    "why_us.f2_tag": "Hotline / Zalo hỗ trợ 24/7",
    ...
    "why_us.f3_tag": "100% HDV có thẻ hành nghề",
    ...
    "why_us.f4_tag": "Xe máy lạnh đời mới & bảo hiểm",
    ...
    "why_us.f5_tag": "Miễn phí hủy tour trước 24h",
    ...
    "why_us.f6_tag": "Tiết kiệm 20% - 40% chi phí",
    ...
    "why_us.f7_tag": "Đậm đà phong vị bản địa",
    ...
    "why_us.f8_tag": "Lên tour riêng theo yêu cầu",
    ...
    "why_us.f9_tag": "Du lịch xanh bảo vệ môi trường",
    ...
    "reviews.verified_count": "12.800+ đánh giá đã xác thực",
    "reviews.google_sub": "6.500+ đánh giá thực tế",
    "reviews.tripadvisor_sub": "Giải thưởng Travelers' Choice 2025",
    "reviews.getyourguide_sub": "Đối tác tour xuất sắc nhất",
    ...
    "reviews.r1_text": "\"Anh hướng dẫn viên Jun cực kỳ tuyệt vời và hiểu biết! Anh ấy giới thiệu rất chi tiết về Bà Nà Hills và chỉ cho đoàn mình những góc chụp ảnh Cầu Vàng siêu đẹp trước khi khách đông. Xe đưa đón tận khách sạn rất đúng giờ và êm ái. Rất đáng giới thiệu!\"",
    "reviews.r1_tag": "Vương quốc Anh • Tour Bà Nà Hills",
    "reviews.r2_text": "\"Xe đưa đón tận nơi rất thuận tiện. Một ngày trải nghiệm tuyệt vời, anh HDV chăm sóc chu đáo và chia sẻ nhiều điều thú vị về văn hóa Hội An. Đi thuyền thả hoa đăng trên sông Hoài như một giấc mơ với gia đình tôi. Tuyệt đối không phát sinh chi phí nào!\"",
    "reviews.r2_tag": "Singapore • Tour Hoàng Hôn Hội An",
    "reviews.r3_text": "\"Trải nghiệm thật kỳ diệu! Cảnh đoàn tàu ven biển qua Đèo Hải Vân đẹp đến ngỡ ngàng. Hướng dẫn viên Oanh chia sẻ những câu chuyện lịch sử Cố đô Huế cực kỳ cuốn hút. Đây là tour du lịch giá trị và ưng ý nhất của chúng tôi tại Việt Nam!\"",
    "reviews.r3_tag": "Úc • Tour Tàu Di Sản Huế & Đèo Hải Vân",
    "reviews.r4_text": "\"Mức giá vô cùng hợp lý và dịch vụ làm tôi hoàn toàn bất ngờ! Bác tài xế lái xe rất an toàn, hướng dẫn viên dẫn đi ăn những món đặc sản địa phương ngon xuất sắc mà khách du lịch bình thường khó tìm ra. Chấm điểm 10/10!\"",
    "reviews.r4_tag": "Nhật Bản • Tour Ẩm Thực Đà Nẵng",
    "reviews.r5_text": "\"Gia đình mình đi tour Cù Lao Chàm cực kỳ hài lòng. Cano cao tốc đời mới, biển trong xanh lặn ngắm san hô thích mê, ăn trưa hải sản tươi rói không phụ thu bất kỳ khoản nào. Chắc chắn sẽ quay lại ủng hộ!\"",
    "reviews.r5_tag": "Hà Nội, VN • Tour Cù Lao Chàm",
    "reviews.r6_text": "\"Chuyến đi trọn vẹn, hướng dẫn viên nhiệt tình, đồ ăn ngon và các điểm tham quan rất đẹp! Chúng tôi đánh giá rất cao sự chu đáo của đội ngũ Da Nang For Less. Tiếng Anh lưu loát, hỗ trợ đặt chỗ nhanh gọn qua website. Đúng chuẩn du lịch chất lượng với giá tốt!\"",
    "reviews.r6_tag": "Đức • Tour Khám Phá Đà Nẵng",

    // Book Without Stress Banner
    "stressfree.badge": "12+ Năm Kinh Nghiệm Bản Địa",
    ...
    "stressfree.b1": "Hủy miễn phí trước 24h",
    "stressfree.b2": "Không chi phí ẩn",
    "stressfree.b3": "Đưa đón tận khách sạn",
    "stressfree.btn": "Nhận Lịch Trình Tùy Chỉnh Miễn Phí",
    "sort.label": "Sắp xếp theo:",
    "sort.price_low_high": "Giá: Thấp đến Cao",
    "sort.price_high_low": "Giá: Cao đến Thấp",
    "guides.more_title": "Thêm Cẩm Nang & Kinh Nghiệm Bản Địa",
    "guides.read_time_4": "4 phút đọc",
    "guides.read_time_6": "6 phút đọc",
    "guides.read_time_3": "3 phút đọc",
